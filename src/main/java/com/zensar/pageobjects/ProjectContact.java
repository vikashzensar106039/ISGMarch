...
public class ProjectContact extends PageBase {
	...
	public void RemoveContactButton()
	{
		...
		embedScreenshot();
		zAssertTrue(isPresent(removefromProjectButton), "Remove button is not there for ISG Contact",
				"Remove button is not there for ISG Contact");
	}
	...
	public void ISGContactAdd()
	{
		...
		embedScreenshot();
		zAssertTrue(isPresent(addEmail), "User entered ISG Email Address",
				"User has not entered ISG Email Address");
		click(saveContact);
